...
try {
	$sql = "SELECT name as \"Name\",'<a href=''building/'||osm_id||'''>'||osm_id||'</a>' as \"Permalink\",photo_url as \"Photo_url\",built_year as \"Built in\",height_above_ground_m as \"Height (m)\" FROM building WHERE osm_id=".$osm_id;
	$sql = sanitizeSQL($sql);
	$pgconn = pgConnection();
