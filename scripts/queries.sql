...
copy users FROM '/opt/osm/pgsqldump/users.txt';
copy nodes FROM '/opt/osm/pgsqldump/nodes.txt';
copy ways FROM '/opt/osm/pgsqldump/ways.txt';
copy way_nodes FROM '/opt/osm/pgsqldump/way_nodes.txt';
copy relations FROM '/opt/osm/pgsqldump/relations.txt';
copy relation_members FROM '/opt/osm/pgsqldump/relation_members.txt';
...
insert into osm_buildings select id,tags->'building','',tags->'name',linestring from ways where exist(tags,'building');
